...
const allResourceFiles = [ 
  ...
  'customer-address.js',
  'customer-saved-search.js',
  'customer.js',
  'discount-code.js',
  'dispute.js',
  'draft-order.js',
  'event.js',
  'fulfillment-event.js',
  'fulfillment-service.js',
  'fulfillment.js',
  'gift-card-adjustment.js',
  'gift-card.js',
  'inventory-item.js',
  'inventory-level.js',
  'location.js',
  ...
  'product.js',
  'province.js',
  'recurring-application-charge.js',
  'redirect.js',
  'refund.js',
  'report.js',
  'resource-feedback.js',
  'script-tag.js',
  'shipping-zone.js',
  'shop.js',
  'smart-collection.js',
  'storefront-access-token.js',
  'tender-transaction.js',
  'theme.js',
  'transaction.js',
  'usage-charge.js',
  'user.js',
